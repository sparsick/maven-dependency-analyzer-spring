...
public class DefaultSpringXmlFileLocatorTest
        extends TestCase {
    ...
    public void testSimpleProject()
        ...
        // run test
        final Set<File> files = locator.locateSpringXmls(project);
        ...
        assertTrue(files.contains(toAbsoluteFile("src/main/resources/main-spring-without-xmlv.xml")));
    }
}
